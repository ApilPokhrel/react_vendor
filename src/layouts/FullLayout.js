...
import FootProvider from "../contexts/bottomNavContext";
    ...
    >
      <FootProvider>
        ...
        <div
          ...
          style={{ marginLeft: 0, backgroundColor: "white", position: "static", paddingTop: "0px" }}
        >
          <div className="page-content container-fluid" style={{ padding: "0px" }}>
